"""An example of ciode submission for the AutoML Decathlon challenge.
...
class PretrainedVideoModel(nn.Module):
    def __init__(self, input_shape, num_classes, use_pretrained=True):
        ...
        self.resnet = r2plus1d_18(weights=R2Plus1D_18_Weights.DEFAULT)
...
class Model:
    def __init__(self, metadata):
        ...
        self.model = PretrainedVideoModel(self.input_shape, self.output_dim)  # maybe change output_dim
        # print(self.model)
    ...
    def is_applicable(metadata):
        ...
        if spacetime_dims == 3:
            ...
            if len(output_shape) > 1:
                if output_shape[0] == input_h and output_shape[1] == input_w:
                    is_applicable = False
