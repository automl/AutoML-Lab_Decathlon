...
class Model:
    def __init__(self, metadata):
        ...
        self.model = SimpleRNN(self.input_shape, self.output_dim)  # maybe change output_dim
        # print(self.model)
    ...
    def is_applicable(metadata):
        ...
        _, input_f, _, _ = input_shape
        output_shape = metadata.get_output_shape()
        if len(output_shape) == 1 and input_f == output_shape[0] and spacetime_dims == 1:
            is_applicable = True
