...
class Model:
    def __init__(self, metadata):
        ...
        self.model = DeepSEA(self.input_shape, self.output_dim)  # maybe change output_dim
        # print(self.model)
